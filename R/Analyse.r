...
############# risk vs age plottet - den hellige gral. ###############
to <- 82.5
...
plot(exp(predict$fit), xlim=c(0,82.5), ylim=c(0,0.60), type = "l", col="blue", xlab = "Age in years", ylab = "Risk of dying from lung cancer (in %)", main="Events at different conc. and ages")
...
legend(5, 0.55, legend=c("Male", "Female", "0 ppm", "448 ppm", "934 ppm"),
